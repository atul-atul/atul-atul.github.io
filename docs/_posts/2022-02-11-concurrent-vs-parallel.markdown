This is the most simplified version of the difference between the two concepts I have found. It is from [Joe Armstrong's blog post][post]. And if anyone knows the difference it'd be Joe. 
