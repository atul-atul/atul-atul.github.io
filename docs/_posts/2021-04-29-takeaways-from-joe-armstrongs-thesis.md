...
This is a fairly involved topic and the post is quite long. I have also written a summary which also is long but somewhat shorter than this post. If you prefer the shorter version it is available [here](https://atul-atul.github.io/summary-joe-armstrongs-thesis-erlang/).
